...
const AllProducts=useSelector((item)=>item.product.products)


  return (
    <div>
          <div className='flex justify-between '>
        <h3 className='border-3 border-[#bebebe] py-1 text-teal-600 font-medium rounded-2xl w-25 px-2 text-center'><span>{AllProducts.length}</span> items</h3>
